...
async function getIcon(name) {
  ...
  svgElem.setAttribute("viewBox", vb[0] + " " + vb[1] + " " + vb[2] + " " + vb[3]);
  var pathElem = document.createElementNS(svgNS, "path");
  pathElem.setAttribute("d", vb[4]);
